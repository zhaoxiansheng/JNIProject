...
public class ZCrash {
    ...
    public static synchronized int init(Context ctx, InitParameters params) {
        if (ZCrash.initialized) {
            return Errno.OK;
        }

        ZCrash.initialized = true;
        ...
        if (params.logger != null) {
            ZCrash.logger = params.logger;
        }

        //save app id
        String packageName = ctx.getPackageName();
        ZCrash.appId = packageName;
        if (TextUtils.isEmpty(ZCrash.appId)) {
            ZCrash.appId = "unknown";
        }
        ...
        ZCrash.appVersion = params.appVersion;

        ZCrash.nativeLibDir = ctx.getApplicationInfo().nativeLibraryDir;

        //save log dir
        if (TextUtils.isEmpty(params.logDir)) {
            params.logDir = ctx.getFilesDir() + "/tombstones";
        }
        ZCrash.logDir = params.logDir;
    ...
    public static class InitParameters {
         ...
         *
         * @param logger An instance of {@link ILogger}.
         * @return The InitParameters object.
         */
         ...
         *
         * @param libLoader An instance of {@link ILibLoader}.
         * @return The InitParameters object.
         */
         ...
         *
         * @param fastCallback An instance of {@link ICrashCallback}.
         * @return The InitParameters object.
         */
        @SuppressWarnings("unused")
